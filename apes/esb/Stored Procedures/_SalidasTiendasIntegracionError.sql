...
CREATE PROCEDURE [esb].[_SalidasTiendasIntegracionError]
	@mid BIGINT, 
	@syncCodigo INT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        WHEN NOT MATCHED BY TARGET THEN
            ...
            externalId,id,sourceId,destinationId,expectedShipmentDate,BODEGA_ORIGEN,BODEGA_DESTINO
            )
            VALUES
            (
            tipo_cambio,estado_cambio,intentos,fecha_ultimo_pull,fecha_ultimo_push,sync_codigo,sync_mensaje,sync_exception,
        ...
        FROM msg.SalidasTiendas_Lineas a
        INNER JOIN @t b ON
            1 = 1
        WHERE
            a.mid = @mid
