...
CREATE PROCEDURE [esb].[_DespachosIntegracionError]
	@mid BIGINT, 
	@syncCodigo INT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        WHEN NOT MATCHED BY TARGET THEN
            ...
            externalId,id,sourceId,destinationId,cliente,agencia,BODEGA_ORIGEN,BODEGA_DESTINO
            )
            VALUES
            (
            tipo_cambio,estado_cambio,intentos,fecha_ultimo_pull,fecha_ultimo_push,sync_codigo,sync_mensaje,sync_exception,
        ...
        SELECT
            b.mid,a.sku,a.match_sku,a.amount,a.expectedShipmentDate
        FROM msg.Despachos_Lineas a
        INNER JOIN @t b ON
            1 = 1
        WHERE
            a.mid = @mid
